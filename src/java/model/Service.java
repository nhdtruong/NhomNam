...
public class Service {
    ...
    // Constructor
    public Service(int service_id, String service_name, boolean is_bhyt, String description,
            CategoryServices category_service, int department_id, double fee, double discount,
            int payment_type_id) {
